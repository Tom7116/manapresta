...
class User implements UserInterface, \Serializable
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Employer", mappedBy="user")
     */
    private $employers;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Prestation", mappedBy="user")
     */
    private $prestations;
